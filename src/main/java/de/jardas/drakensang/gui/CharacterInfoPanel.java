...
public class CharacterInfoPanel extends JPanel {
	...
	private void update() {
		...
		add(createMiscFields(), new GridBagConstraints(2, 0, 1, 1, 0, 0,
				GridBagConstraints.NORTHWEST, GridBagConstraints.HORIZONTAL,
				new Insets(3, 6, 3, 6), 0, 0));

		add(new JLabel(), new GridBagConstraints(1, row, 2, 1, 1, 1,
	...
	private void addArchetypeFields(int panelRow) {
		...
		archetypePanel.setBorder(BorderFactory.createTitledBorder(Messages
				.get("Archetype")));
		add(archetypePanel, new GridBagConstraints(0, panelRow, 1, 1, 1, 0,
