...
public class Wizard extends WindowAdapter implements PropertyChangeListener {
    ...
    final static String BACK_TEXT = Messages.get("wizard.back");
    final static String NEXT_TEXT = Messages.get("wizard.next");
    final static String FINISH_TEXT = Messages.get("wizard.finish");
    final static String CANCEL_TEXT = Messages.get("wizard.cancel");
